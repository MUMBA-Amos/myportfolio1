...
const Header = ({ contactRef }) => {
  ...
  return (
    <>
        ...
        <div className="container">
          ...
          <div className="hero-content row align-items-center text-white mt-5">
            ...
            <div className="hero-text col-lg-8 col-md-7 col-sm-12 order-2 order-md-1">
              <h1>
                Hello I'm{" "}
                <span className="text-success">Mumba Amos Ntambo</span>
              </h1>
      ...
      {/* Modal for displaying the phone number */}
      <Modal show={showModal} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Contact Me</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p>You can call me at:</p>
          <h4>+1234567890</h4> {/* Replace with your actual phone number */}
        </Modal.Body>
        <Modal.Footer>
          <Button variant="secondary" onClick={handleClose}>
            Close
          </Button>
          <Button variant="success" href="tel:+1234567890">
            {" "}
